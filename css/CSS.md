...
- 静态定位是元素的默认定位方式，无定位的意思。相当于border 里面的none，不要定位的时候用
...
![05_绝对定位_父级无定位](CSS.assets/05_绝对定位_父级无定位.png)
...
![11_绝对定位居中示意图](CSS.assets/11_绝对定位居中示意图.png)
